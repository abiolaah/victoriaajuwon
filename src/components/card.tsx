...
const Card: React.FC<CardProps> = ({ data, dataType, role, skills }) => {
  ...
  const projectSkills =
    isProject(data) && skills
      ? getProjectSkills(data, skills, role || "ALL")
      : [];
  ...
  return (
    ...
    >
      {/* Card Container */}
      <div
        className={`relative h-fit w-full rounded-md overflow-hidden bg-zinc-900 shadow-lg transition-transform duration-300 ${
